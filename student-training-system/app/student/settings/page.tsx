...
import { ArrowLeft, Save, Shield, Bell, Palette, Download } from "lucide-react"
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Tự động lưu nháp khi nhập</p>
                  </div>
                  <Switch
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">27/12/2024</span>
                </div>
                <div className="flex justify-between">
